...
# NOTE: this script is 1/2 of the original keggur.pl script. It starts AFTER the step where sequences are collected from the KEGG database, allowing for users to introduce their own curated sequences prior to alignment.
