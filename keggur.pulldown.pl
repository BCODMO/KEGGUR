...
#N NOTE: this is 1/2 of the original keggur.pl script. It ONLY pulls down sequences from the indicated orthology group from the online database, and does not proceed with the downstream processing steps.
